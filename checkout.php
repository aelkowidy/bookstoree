...
<!--header section ends-->
    ...
    <section class="checkout">
        ...
        <h1 class="heading-3"> <span>Checkout</span> </h1>
    </div>
    <div class="checkout">
        ...
        <div class="cart-items">
            ...
            <h3>cart items</h3>
            <p><span class="name">Featured Books</span><span class="price">$15.99</span></p>
            <p><span class="name">Featured Books</span><span class="price">$15.99</span></p>
            <p><span class="name">Featured Books</span><span class="price">$15.99</span></p>
            <p class="grand-total"><span class="name-1">grand total :</span><span class="price-1">47.97</span></p>
        ...
        <div class="user-info">
            ...
            <p><i class="fas fa-phone"></i><span>01116550042</span></p>
            <p><i class="fas fa-envelope"></i><span>username@gmail.com</span></p>
            <a href="update_profile.html" class="btn">Update info</a>
            <h3>your address</h3>
            <p><i class="fas fa-map-marker-alt"></i><span>flat no. 1, building no. 1, loran, Alexandra,Egypt</span></p>
            <a href="update_address.html" class="btn">update_address</a>
            ...
            <a href="orders.html" class="btn" style="width:100%; text-align: center; background:var(--black); color: #fff;">Place order</a>
        </div>
    </form>
